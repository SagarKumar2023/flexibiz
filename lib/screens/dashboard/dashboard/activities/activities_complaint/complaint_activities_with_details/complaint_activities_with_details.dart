...
class ComplaintActivitiesWithDetails extends StatefulWidget {
  const ComplaintActivitiesWithDetails({super.key});

  @override
  State<ComplaintActivitiesWithDetails> createState() =>
      _ComplaintActivitiesWithDetailsState();
}

class _ComplaintActivitiesWithDetailsState extends State<ComplaintActivitiesWithDetails> {
