...
class ComplaintAutoLoggedMail extends StatefulWidget {
  final String? selectedCategory;
  final List<Map<String, dynamic>>? selectedFiles;

  const ComplaintAutoLoggedMail({
    super.key,
    this.selectedFiles,
  ...
  @override
  State<ComplaintAutoLoggedMail> createState() => _ComplaintAutoLoggedMailState();
}

class _ComplaintAutoLoggedMailState extends State<ComplaintAutoLoggedMail> {
