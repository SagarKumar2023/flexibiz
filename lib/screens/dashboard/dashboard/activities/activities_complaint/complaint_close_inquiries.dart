...
class ComplaintCloseInquiries extends StatefulWidget {
  const ComplaintCloseInquiries({super.key});

  @override
  State<ComplaintCloseInquiries> createState() => _ComplaintCloseInquiriesState();
}

class _ComplaintCloseInquiriesState extends State<ComplaintCloseInquiries> {
