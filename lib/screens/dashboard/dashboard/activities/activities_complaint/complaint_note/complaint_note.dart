...
import 'package:flexibiz/screens/dashboard/dashboard/activities/activities_complaint/complaint_note/complaint_create_note.dart';
import 'package:flexibiz/screens/dashboard/dashboard/activities/activities_complaint/complaint_note/complaint_note_edit.dart';
...
class ComplaintNote extends StatefulWidget {
  const ComplaintNote({super.key});

  @override
  State<ComplaintNote> createState() => _ComplaintNoteState();
}

class _ComplaintNoteState extends State<ComplaintNote> {
        ...
        actions: [
          Padding(
            ...
            child: GestureDetector(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) => ComplaintCreateNote(),));
              },
                                          ...
                                          child: Column(
                                            children: [
                                              _threeDotInsideItem(
                                                ...
                                                title: "Edit",
                                                onTap: () {
                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => ComplaintNoteEdit(),));
                                                },
                                              ),
                                              _threeDotInsideItem(
