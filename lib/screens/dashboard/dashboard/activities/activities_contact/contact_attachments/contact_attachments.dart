...
import 'package:flexibiz/screens/dashboard/dashboard/activities/activities_contact/contact_attachments/contact_attachments_edit.dart';
...
class ContactAttachments extends StatefulWidget {
  const ContactAttachments({super.key});

  @override
  State<ContactAttachments> createState() => _ContactAttachmentsState();
}

class _ContactAttachmentsState extends State<ContactAttachments> {
                                                                ...
                                                                BottomSheetActionTile(
                                                                  ...
                                                                  onTap: () {
                                                                    ...
                                                                    ScreenNavigationUtils.push(
                                                                      context,
                                                                      child: const ContactAttachmentsEdit(),
