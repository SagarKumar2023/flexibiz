...
class ContactAutoLoggedMail extends StatefulWidget {
  final String? selectedCategory;
  final List<Map<String, dynamic>>? selectedFiles;

  const ContactAutoLoggedMail({
    super.key,
    this.selectedFiles,
  ...
  @override
  State<ContactAutoLoggedMail> createState() => _ContactAutoLoggedMailState();
}

class _ContactAutoLoggedMailState extends State<ContactAutoLoggedMail> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        titleSpacing: -8,
        title: TextWidget(
          text: "VAIBHAV BANSAL NEW TESTp".toUpperCase(),
          fontSize: 15,
