...
class ContactLeadDialog extends StatefulWidget {
  ...
  @override
  State<ContactLeadDialog> createState() => _ContactLeadDialogState();
}

class _ContactLeadDialogState extends State<ContactLeadDialog> {
