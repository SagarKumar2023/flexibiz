...
class ContactLogFollowups extends StatefulWidget {
  const ContactLogFollowups({super.key});

  @override
  State<ContactLogFollowups> createState() => _ContactLogFollowupsState();
}

class _ContactLogFollowupsState extends State<ContactLogFollowups> {
  @override
