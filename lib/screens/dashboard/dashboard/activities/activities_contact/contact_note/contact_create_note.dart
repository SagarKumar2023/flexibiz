...
class ContactCreateNote extends StatefulWidget {
  const ContactCreateNote({super.key});

  @override
  State<ContactCreateNote> createState() => _ContactCreateNoteState();
}

class _ContactCreateNoteState extends State<ContactCreateNote> {
