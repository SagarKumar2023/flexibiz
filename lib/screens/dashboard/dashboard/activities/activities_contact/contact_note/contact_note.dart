...
import 'package:flexibiz/screens/dashboard/dashboard/activities/activities_contact/contact_note/contact_create_note.dart';
import 'package:flexibiz/screens/dashboard/dashboard/activities/activities_contact/contact_note/contact_note_edit.dart';
...
class ContactNote extends StatefulWidget {
  const ContactNote({super.key});

  @override
  State<ContactNote> createState() => _ContactNoteState();
}

class _ContactNoteState extends State<ContactNote> {
        ...
        actions: [
          Padding(
            ...
            child: GestureDetector(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) => ContactCreateNote(),));
              },
                                          ...
                                          child: Column(
                                            children: [
                                              _threeDotInsideItem(
                                                ...
                                                title: "Edit",
                                                onTap: () {
                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => ContactNoteEdit(),));
                                                },
                                              ),
                                              _threeDotInsideItem(
