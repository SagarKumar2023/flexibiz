...
class ContactNoteEdit extends StatefulWidget {
  const ContactNoteEdit({super.key});

  @override
  State<ContactNoteEdit> createState() => _ContactNoteEditState();
}

class _ContactNoteEditState extends State<ContactNoteEdit> {
