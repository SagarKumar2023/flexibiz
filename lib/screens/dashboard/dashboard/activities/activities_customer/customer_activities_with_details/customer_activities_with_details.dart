...
class CustomerActivitiesWithDetails extends StatefulWidget {
  const CustomerActivitiesWithDetails({super.key});

  @override
  State<CustomerActivitiesWithDetails> createState() =>
      _CustomerActivitiesWithDetailsState();
}

class _CustomerActivitiesWithDetailsState extends State<CustomerActivitiesWithDetails> {
