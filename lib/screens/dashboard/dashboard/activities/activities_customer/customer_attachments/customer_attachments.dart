...
import 'package:flexibiz/screens/dashboard/dashboard/activities/activities_customer/customer_attachments/customer_attachments_edit.dart';
...
class CustomerAttachments extends StatefulWidget {
  const CustomerAttachments({super.key});

  @override
  State<CustomerAttachments> createState() => _CustomerAttachmentsState();
}

class _CustomerAttachmentsState extends State<CustomerAttachments> {
                                                                ...
                                                                BottomSheetActionTile(
                                                                  ...
                                                                  onTap: () {
                                                                    ...
                                                                    ScreenNavigationUtils.push(
                                                                      context,
                                                                      child: const CustomerAttachmentsEdit(),
