...
class CustomerAutoLoggedMail extends StatefulWidget {
  final String? selectedCategory;
  final List<Map<String, dynamic>>? selectedFiles;

  const CustomerAutoLoggedMail({
    super.key,
    this.selectedFiles,
  ...
  @override
  State<CustomerAutoLoggedMail> createState() => _CustomerAutoLoggedMailState();
}

class _CustomerAutoLoggedMailState extends State<CustomerAutoLoggedMail> {
