...
class CustomerChooseFromServer extends StatefulWidget {
  const CustomerChooseFromServer({super.key});

  @override
  State<CustomerChooseFromServer> createState() =>
      _CustomerChooseFromServerState();
}

class _CustomerChooseFromServerState extends State<CustomerChooseFromServer> {
