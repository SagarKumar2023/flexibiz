...
class CustomerCloseInquiries extends StatefulWidget {
  const CustomerCloseInquiries({super.key});

  @override
  State<CustomerCloseInquiries> createState() => _CustomerCloseInquiriesState();
}

class _CustomerCloseInquiriesState extends State<CustomerCloseInquiries> {
