...
class CustomerLeadDialog extends StatefulWidget {
  ...
  @override
  State<CustomerLeadDialog> createState() => _CustomerLeadDialogState();
}

class _CustomerLeadDialogState extends State<CustomerLeadDialog> {
