...
class CustomerLogFollowups extends StatefulWidget {
  const CustomerLogFollowups({super.key});

  @override
  State<CustomerLogFollowups> createState() => _CustomerLogFollowupsState();
}

class _CustomerLogFollowupsState extends State<CustomerLogFollowups> {
  @override
