...
class CustomerNewContacts extends StatefulWidget {
  const CustomerNewContacts({super.key});

  @override
  State<CustomerNewContacts> createState() => _CustomerNewContactsState();
}

class _CustomerNewContactsState extends State<CustomerNewContacts> {
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          decoration: BoxDecoration(
                            color: addressIsExpanded ?Color(0xffdfe4ea):Colors.transparent,
                            borderRadius: BorderRadius.circular(30),
                          ),
                          padding: EdgeInsets.all(15),
                          child: Column(
                        ...
                        VerticalSpace(height: addressIsExpanded?20:0),
                        /// ----------------------- Grouping section ------------------------------
                        Padding(
                          padding:  EdgeInsets.only(left: 15,right:15),
                          // padding:  EdgeInsets.only(left: groupingsIsExpanded?0:15,right:groupingsIsExpanded ?0:15),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              const TextWidget(
                        ...
                        VerticalSpace(height: groupingsIsExpanded?20:0),
