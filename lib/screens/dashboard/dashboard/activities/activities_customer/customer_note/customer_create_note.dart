...
class CustomerCreateNote extends StatefulWidget {
  const CustomerCreateNote({super.key});

  @override
  State<CustomerCreateNote> createState() => _CustomerCreateNoteState();
}

class _CustomerCreateNoteState extends State<CustomerCreateNote> {
