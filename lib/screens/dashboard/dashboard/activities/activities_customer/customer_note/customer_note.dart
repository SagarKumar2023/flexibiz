...
import 'package:flexibiz/screens/dashboard/dashboard/activities/activities_customer/customer_note/customer_create_note.dart';
import 'package:flexibiz/screens/dashboard/dashboard/activities/activities_customer/customer_note/customer_note_edit.dart';
...
class CustomerNote extends StatefulWidget {
  const CustomerNote({super.key});

  @override
  State<CustomerNote> createState() => _CustomerNoteState();
}

class _CustomerNoteState extends State<CustomerNote> {
        ...
        actions: [
          Padding(
            ...
            child: GestureDetector(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) => CustomerCreateNote(),));
              },
                                          ...
                                          child: Column(
                                            children: [
                                              _threeDotInsideItem(
                                                ...
                                                title: "Edit",
                                                onTap: () {
                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => CustomerNoteEdit(),));
                                                },
                                              ),
                                              _threeDotInsideItem(
