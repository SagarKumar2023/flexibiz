...
class CustomerNoteEdit extends StatefulWidget {
  const CustomerNoteEdit({super.key});

  @override
  State<CustomerNoteEdit> createState() => _CustomerNoteEditState();
}

class _CustomerNoteEditState extends State<CustomerNoteEdit> {
