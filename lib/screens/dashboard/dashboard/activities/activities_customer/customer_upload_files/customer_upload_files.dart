...
class CustomerUploadFiles extends ConsumerStatefulWidget {
  const CustomerUploadFiles({super.key});

  @override
  ConsumerState<CustomerUploadFiles> createState() => _CustomerUploadFilesState();
}

class _CustomerUploadFilesState extends ConsumerState<CustomerUploadFiles> {
