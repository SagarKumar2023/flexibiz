...
class InquiriesActivitiesWithDetails extends StatefulWidget {
  const InquiriesActivitiesWithDetails({super.key});

  @override
  State<InquiriesActivitiesWithDetails> createState() =>
      _InquiriesActivitiesWithDetailsState();
}

class _InquiriesActivitiesWithDetailsState extends State<InquiriesActivitiesWithDetails> {
