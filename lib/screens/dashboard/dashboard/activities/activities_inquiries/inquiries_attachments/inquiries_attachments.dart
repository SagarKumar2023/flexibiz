...
import 'package:flexibiz/screens/dashboard/dashboard/activities/activities_inquiries/inquiries_attachments/inquiries_attachments_edit.dart';
...
class InquiriesAttachments extends StatefulWidget {
  const InquiriesAttachments({super.key});

  @override
  State<InquiriesAttachments> createState() => _InquiriesAttachmentsState();
}

class _InquiriesAttachmentsState extends State<InquiriesAttachments> {
            ...
            child: GestureDetector(
              onTap: (){
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => InquiriesUploadFiles(),
                  ),
                );
              },
              child: TextWidget(
