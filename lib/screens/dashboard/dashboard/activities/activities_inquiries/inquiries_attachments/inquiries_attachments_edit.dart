...
class InquiriesAttachmentsEdit extends StatefulWidget {
  const InquiriesAttachmentsEdit({super.key});

  @override
  State<InquiriesAttachmentsEdit> createState() => _InquiriesAttachmentsEditState();
}

class _InquiriesAttachmentsEditState extends State<InquiriesAttachmentsEdit> {
