...
class InquiriesAutoLoggedMail extends StatefulWidget {
  final String? selectedCategory;
  final List<Map<String, dynamic>>? selectedFiles;

  const InquiriesAutoLoggedMail({
    super.key,
    this.selectedFiles,
  ...
  @override
  State<InquiriesAutoLoggedMail> createState() => _InquiriesAutoLoggedMailState();
}

class _InquiriesAutoLoggedMailState extends State<InquiriesAutoLoggedMail> {
