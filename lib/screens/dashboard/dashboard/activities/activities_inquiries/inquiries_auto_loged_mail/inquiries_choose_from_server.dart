...
class InquiriesChooseFromServer extends StatefulWidget {
  const InquiriesChooseFromServer({super.key});

  @override
  State<InquiriesChooseFromServer> createState() =>
      _InquiriesChooseFromServerState();
}

class _InquiriesChooseFromServerState extends State<InquiriesChooseFromServer> {
