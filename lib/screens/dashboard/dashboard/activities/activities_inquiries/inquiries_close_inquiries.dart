...
class InquiriesCloseInquiries extends StatefulWidget {
  const InquiriesCloseInquiries({super.key});

  @override
  State<InquiriesCloseInquiries> createState() => _InquiriesCloseInquiriesState();
}

class _InquiriesCloseInquiriesState extends State<InquiriesCloseInquiries> {
