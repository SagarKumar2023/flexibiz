...
class InquiriesEditContact extends StatefulWidget {
  const InquiriesEditContact({super.key});

  @override
  State<InquiriesEditContact> createState() => _InquiriesEditContactState();
}

class _InquiriesEditContactState extends State<InquiriesEditContact> {
