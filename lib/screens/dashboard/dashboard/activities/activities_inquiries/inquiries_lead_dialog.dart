...
class InquiriesLeadDialog extends StatefulWidget {
  ...
  @override
  State<InquiriesLeadDialog> createState() => _InquiriesLeadDialogState();
}

class _InquiriesLeadDialogState extends State<InquiriesLeadDialog> {
