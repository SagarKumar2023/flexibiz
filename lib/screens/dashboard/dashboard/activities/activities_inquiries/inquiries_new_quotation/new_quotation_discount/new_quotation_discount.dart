...
class NewQuotationDiscount extends StatefulWidget {
  const NewQuotationDiscount({super.key});

  @override
  State<NewQuotationDiscount> createState() => _NewQuotationDiscountState();
}

class _NewQuotationDiscountState extends State<NewQuotationDiscount> {
