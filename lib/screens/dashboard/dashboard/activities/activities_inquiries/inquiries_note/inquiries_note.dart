...
class InquiriesNote extends StatefulWidget {
  const InquiriesNote({super.key});

  @override
  State<InquiriesNote> createState() => _InquiriesNoteState();
}

class _InquiriesNoteState extends State<InquiriesNote> {
