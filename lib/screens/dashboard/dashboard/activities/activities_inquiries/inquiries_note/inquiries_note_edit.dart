...
class InquiriesNoteEdit extends StatefulWidget {
  const InquiriesNoteEdit({super.key});

  @override
  State<InquiriesNoteEdit> createState() => _InquiriesNoteEditState();
}

class _InquiriesNoteEditState extends State<InquiriesNoteEdit> {
