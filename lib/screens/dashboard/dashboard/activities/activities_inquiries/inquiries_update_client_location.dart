...
class InquiriesUpdateClientLocation extends StatefulWidget {
  const InquiriesUpdateClientLocation({super.key});

  @override
  State<InquiriesUpdateClientLocation> createState() => _InquiriesUpdateClientLocationState();
}

class _InquiriesUpdateClientLocationState extends State<InquiriesUpdateClientLocation> {
