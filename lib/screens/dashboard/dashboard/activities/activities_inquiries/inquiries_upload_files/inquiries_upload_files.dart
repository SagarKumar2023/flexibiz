...
class InquiriesUploadFiles extends ConsumerStatefulWidget {
  const InquiriesUploadFiles({super.key});

  @override
  ConsumerState<InquiriesUploadFiles> createState() => _InquiriesUploadFilesState();
}

class _InquiriesUploadFilesState extends ConsumerState<InquiriesUploadFiles> {
