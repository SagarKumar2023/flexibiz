...
class InquiriesVerification extends StatefulWidget {
  const InquiriesVerification({super.key});

  @override
  State<InquiriesVerification> createState() => _InquiriesVerificationState();
}

class _InquiriesVerificationState extends State<InquiriesVerification> {
