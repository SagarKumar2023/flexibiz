...
class ActivitiesUploadFiles extends ConsumerStatefulWidget {
  const ActivitiesUploadFiles({super.key});

  @override
  ConsumerState<ActivitiesUploadFiles> createState() => _ActivitiesUploadFilesState();
}

class _ActivitiesUploadFilesState extends ConsumerState<ActivitiesUploadFiles> {
