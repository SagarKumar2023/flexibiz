...
class ActivitiesAttachments extends StatefulWidget {
  const ActivitiesAttachments({super.key});

  @override
  State<ActivitiesAttachments> createState() => _ActivitiesAttachmentsState();
}

class _ActivitiesAttachmentsState extends State<ActivitiesAttachments> {
