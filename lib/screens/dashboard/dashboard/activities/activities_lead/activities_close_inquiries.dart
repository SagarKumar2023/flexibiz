...
class ActivitiesCloseInquiries extends StatefulWidget {
  const ActivitiesCloseInquiries({super.key});

  @override
  State<ActivitiesCloseInquiries> createState() => _ActivitiesCloseInquiriesState();
}

class _ActivitiesCloseInquiriesState extends State<ActivitiesCloseInquiries> {
