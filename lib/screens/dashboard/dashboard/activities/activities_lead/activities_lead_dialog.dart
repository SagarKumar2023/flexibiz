...
class ActivityLeadDialog extends StatefulWidget {
  ...
  final void Function(bool isSelectAll) onOk;
                ...
                children: [
                    ...
                    children: [
                      InkWell(
                        ...
                        child: Container(
                          ...
                          height: 20,
                          decoration: BoxDecoration(
                            color:isSelectAll ? Color(0xff007BFF) : Colors.white,
                            borderRadius: BorderRadius.circular(4),
                            border: Border.all(
                              color: isSelectAll ? Color(0xff007BFF) : Color(0xFFEAECF0),
                              width: 2,
                            ),
                          ),
                          child: isSelectAll ?
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: ButtonWidget(
                          navigateTo: ()=>widget.onOk(isSelectAll),
                          buttonName: 'Ok',
                          borderRadius: 30,
                          height: 50,
                          buttonTextColor: ColorUtils.white,
