...
class ActivitiesLogFollowups extends StatefulWidget {
  const ActivitiesLogFollowups({super.key});

  @override
  State<ActivitiesLogFollowups> createState() => _ActivitiesLogFollowupsState();
}

class _ActivitiesLogFollowupsState extends State<ActivitiesLogFollowups> {
  @override
