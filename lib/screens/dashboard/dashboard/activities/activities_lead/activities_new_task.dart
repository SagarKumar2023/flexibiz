...
class ActivitiesNewTask extends StatefulWidget {
  const ActivitiesNewTask({super.key});

  @override
  State<ActivitiesNewTask> createState() => _ActivitiesNewTaskState();
}

class _ActivitiesNewTaskState extends State<ActivitiesNewTask> {
