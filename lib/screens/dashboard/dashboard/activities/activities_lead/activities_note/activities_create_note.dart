...
class ActivitiesCreateNote extends StatefulWidget {
  const ActivitiesCreateNote({super.key});

  @override
  State<ActivitiesCreateNote> createState() => _ActivitiesCreateNoteState();
}

class _ActivitiesCreateNoteState extends State<ActivitiesCreateNote> {
