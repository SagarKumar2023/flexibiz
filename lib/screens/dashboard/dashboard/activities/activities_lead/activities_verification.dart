...
class ActivitiesVerification extends StatefulWidget {
  const ActivitiesVerification({super.key});

  @override
  State<ActivitiesVerification> createState() => _ActivitiesVerificationState();
}

class _ActivitiesVerificationState extends State<ActivitiesVerification> {
