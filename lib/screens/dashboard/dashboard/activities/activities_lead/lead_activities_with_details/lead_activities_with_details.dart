...
class LeadActivitiesWithDetails extends StatefulWidget {
  const LeadActivitiesWithDetails({super.key});

  @override
  State<LeadActivitiesWithDetails> createState() => _LeadActivitiesWithDetailsState();
}



class _LeadActivitiesWithDetailsState extends State<LeadActivitiesWithDetails> {
                ...
                child: Theme(
                  ...
                  child: ExpansionTile(
                    ...
                    children: [
                      ...
                      LeadInformationInnerWidgetWithValueIcon(label: "Mobile", value: "9958859899", valueIcon: ImagesUtils.mobileNoIcon,isUnderline: true,onTap: (){ContactActionUtils.makePhoneCall("9958859899");},),
                      LeadInformationInnerWidgetWithValueIcon(label: "MailId", value: "vbansal134@gmail.com", valueIcon: ImagesUtils.emailIcon,onTap: (){ContactActionUtils.sendEmail("vbansal134@gmail.com");},),
