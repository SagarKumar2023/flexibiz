...
class CustomerNewContact extends StatefulWidget {
  const CustomerNewContact({super.key});

  @override
  State<CustomerNewContact> createState() => _CustomerNewContactState();
}

class _CustomerNewContactState extends State<CustomerNewContact> {
