...
class LeadNewContact extends StatefulWidget {
  const LeadNewContact({super.key});

  @override
  State<LeadNewContact> createState() => _LeadNewContactState();
}

class _LeadNewContactState extends State<LeadNewContact> {
  ...
  void _editAndSubmitData() {
    ...
    if (site.isNotEmpty && !Uri.tryParse(site)!.hasAbsolutePath) {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  VerticalSpace(height: addressIsExpanded?10:0),
                  /// ----------------------- Grouping section ------------------------------
                  Padding(
                    padding:  EdgeInsets.only(left: 15,right:15),
                    child: Row(
