...
class ActivityLeadDialog extends StatefulWidget {
  ...
  @override
  State<ActivityLeadDialog> createState() => _ActivityLeadDialogState();
}

class _ActivityLeadDialogState extends State<ActivityLeadDialog> {
...
class MarkAttendanceOutDialog extends StatefulWidget {
  const MarkAttendanceOutDialog({super.key});

  @override
  State<MarkAttendanceOutDialog> createState() => _MarkAttendanceOutDialogState();
}

class _MarkAttendanceOutDialogState extends State<MarkAttendanceOutDialog> {
