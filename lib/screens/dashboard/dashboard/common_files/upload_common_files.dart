...
class UploadCommonFiles extends StatefulWidget {
  const UploadCommonFiles({super.key});

  @override
  State<UploadCommonFiles> createState() => _UploadCommonFilesState();
}

class _UploadCommonFilesState extends State<UploadCommonFiles> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            TextWidget(
              text: "upload common files".toUpperCase(),
          ...
          children: [
            ...
            Container(
              ...
              child: PopupMenuButton<String>(
                ...
                onSelected: (value) {
                  setState(() {
                    whereToUploadImageSelectValue = value;
                  });
                },
                itemBuilder: (context) {
                  return whereToUploadImageCategoryList.map((item) {
                ...
                child: Row(
                  ...
                  children: [
                    TextWidget(
                      text: whereToUploadImageSelectValue,
                      fontSize: 14,
                      textAlign: TextAlign.center,
                      textColor: ColorUtils.black,
                      fontWeight: FontWeight.w500,
