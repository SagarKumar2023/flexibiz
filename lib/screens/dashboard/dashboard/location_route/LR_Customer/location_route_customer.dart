...
import 'package:flexibiz/screens/dashboard/dashboard/location_route/LR_Customer/location_route_customer_details.dart';
...
enum LocationRouteCustomerTab { mapTabScreen, leadListTabScreen }

class LocationRouteCustomer extends StatefulWidget {
  const LocationRouteCustomer({super.key});

  @override
  State<LocationRouteCustomer> createState() => _LocationRouteCustomerState();
}

class _LocationRouteCustomerState extends State<LocationRouteCustomer> {
  bool isSearchShow = false;
  bool isLeadNearAboutContentExpanded = false;
  bool isDefaultRadiusChecked = false;
  LocationRouteCustomerTab selectedTab = LocationRouteCustomerTab.mapTabScreen;
      ...
      body: Container(
        ...
        child: Column(
          children: [
                ...
                children: [
                  isSearchShow
                    ...
                    children: [
                      ...
                      if (selectedTab == LocationRouteCustomerTab.leadListTabScreen)
                        InkWell(
                          onTap: () {
                  ...
                  Row(
                    children: [
                      _tabItem(
                        tab: LocationRouteCustomerTab.mapTabScreen,
                        icon: ImagesUtils.globalIcon,
                      ),
                      _tabItem(
                        tab: LocationRouteCustomerTab.leadListTabScreen,
            ...
            /// BODY  SECTION
            Expanded(
              child: selectedTab == LocationRouteCustomerTab.mapTabScreen
                  ? Container(
  ...
  /// ================= TAB ITEM =================
  Widget _tabItem({required LocationRouteCustomerTab tab, required String icon}) {
