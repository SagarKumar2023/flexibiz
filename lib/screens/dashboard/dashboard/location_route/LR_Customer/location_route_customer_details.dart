...
class LocationRouteCustomerDetails extends StatefulWidget {
  const LocationRouteCustomerDetails({super.key});

  @override
  State<LocationRouteCustomerDetails> createState() => _LocationRouteCustomerDetailsState();
}

class _LocationRouteCustomerDetailsState extends State<LocationRouteCustomerDetails> {
