...
enum LocationRouteLeadTab { mapTabScreen, leadListTabScreen }

class LocationRouteLead extends StatefulWidget {
  const LocationRouteLead({super.key});

  @override
  State<LocationRouteLead> createState() => _LocationRouteLeadState();
}

class _LocationRouteLeadState extends State<LocationRouteLead> {
  bool isSearchShow = false;
  bool isLeadNearAboutContentExpanded = false;
  bool isDefaultRadiusChecked = false;
  LocationRouteLeadTab selectedTab = LocationRouteLeadTab.mapTabScreen;
      ...
      body: Container(
        ...
        child: Column(
          children: [
                ...
                children: [
                  isSearchShow
                    ...
                    children: [
                      ...
                      if (selectedTab == LocationRouteLeadTab.leadListTabScreen)
                        InkWell(
                          onTap: () {
                  ...
                  Row(
                    children: [
                      _tabItem(
                        tab: LocationRouteLeadTab.mapTabScreen,
                        icon: ImagesUtils.globalIcon,
                      ),
                      _tabItem(
                        tab: LocationRouteLeadTab.leadListTabScreen,
            ...
            /// BODY  SECTION
            Expanded(
              child: selectedTab == LocationRouteLeadTab.mapTabScreen
                  ? Container(
  ...
  /// ================= TAB ITEM =================
  Widget _tabItem({required LocationRouteLeadTab tab, required String icon}) {
