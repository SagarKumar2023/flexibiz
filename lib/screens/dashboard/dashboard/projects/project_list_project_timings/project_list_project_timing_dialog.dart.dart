...
import 'package:flexibiz/screens/dashboard/dashboard/projects/project_list_project_timings/project_list_project_timings_details.dart';
...
class ProjectListProjectTimingDialog extends StatefulWidget {
  const ProjectListProjectTimingDialog({super.key});

  @override
  State<ProjectListProjectTimingDialog> createState() =>
      _ProjectListProjectTimingDialogState();
}

class _ProjectListProjectTimingDialogState extends State<ProjectListProjectTimingDialog> {
  DateTime? fromDate;
  DateTime? toDate;
                        ...
                        child: ButtonWidget(
                          navigateTo: () {
                            ...
                            ScreenNavigationUtils.push(
                              context,
                              child: ProjectListProjectTimingsDetails(
                                fromDate: fromDate!,
                                toDate: toDate!,
                              ),
