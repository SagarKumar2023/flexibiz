...
import 'package:flexibiz/screens/dashboard/dashboard/projects/project_view_project_timing/project_view_project_timings_details/project_view_project_timings_details.dart';
...
class ProjectViewProjectTimingDialog extends StatefulWidget {

  const ProjectViewProjectTimingDialog({
    super.key,
  });

  @override
  State<ProjectViewProjectTimingDialog> createState() => _ProjectViewProjectTimingDialogState();
}

class _ProjectViewProjectTimingDialogState extends State<ProjectViewProjectTimingDialog> {
                        ...
                        child: ButtonWidget(
                          navigateTo: () {
                            if (fromDate == null || toDate == null) {
                              SnackBarUtils.showWarning('Warning', 'Please select From date and To date');
                              return;
                            }
                            ...
                            ScreenNavigationUtils.push(
                              context,
                              child: ProjectViewProjectTimingsDetails(
                                fromDate: fromDate!,
                                toDate: toDate!,
                              ),
