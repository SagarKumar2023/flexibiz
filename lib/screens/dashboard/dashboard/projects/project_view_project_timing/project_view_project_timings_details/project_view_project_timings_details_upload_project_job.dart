...
import 'package:flexibiz/screens/dashboard/dashboard/projects/project_view_project_timing/project_view_project_timings_details/project_view_project_timings_details_server.dart';
...
class ProjectViewProjectTimingsDetailsUploadProjectJob extends StatefulWidget {
  final String selectedJob;

  const ProjectViewProjectTimingsDetailsUploadProjectJob({super.key, required this.selectedJob});

  @override
  State<ProjectViewProjectTimingsDetailsUploadProjectJob> createState() => _ProjectViewProjectTimingsDetailsUploadProjectJobState();
}

class _ProjectViewProjectTimingsDetailsUploadProjectJobState extends State<ProjectViewProjectTimingsDetailsUploadProjectJob> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: TextWidget(
          text: widget.selectedJob.toUpperCase(),
                                                  ...
                                                  BottomSheetActionTile(
                                                    ...
                                                    onTap: () {
                                                      ...
                                                      ScreenNavigationUtils.pushReplacement(
                                                        context,
                                                        child: const ProjectViewProjectTimingsDetailsServer(),
