...
class ProjectWorkingAutoLogedMail extends StatefulWidget {
  final String? selectedCategory;
  final List<Map<String, dynamic>>? selectedFiles;

  const ProjectWorkingAutoLogedMail({
    super.key,
    this.selectedFiles,
  ...
  @override
  State<ProjectWorkingAutoLogedMail> createState() => _ProjectWorkingAutoLogedMailState();
}

class _ProjectWorkingAutoLogedMailState extends State<ProjectWorkingAutoLogedMail> {
