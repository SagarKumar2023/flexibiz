...
class ProjectWorkingNewTask extends StatefulWidget {
  const ProjectWorkingNewTask({super.key});

  @override
  State<ProjectWorkingNewTask> createState() => _ProjectWorkingNewTaskState();
}

class _ProjectWorkingNewTaskState extends State<ProjectWorkingNewTask> {
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: TextWidget(
                text: 'Please enter date and time fir above task. This information will help corresponding user to inline with the task.',
                fontSize: 14,
            ...
            GestureDetector(
              onTap: () {
                openSuperExecutiveSheet(context);
              },
              child: Container(
                ...
                child: Row(
                  children: [
                    Image.asset(
                      ImagesUtils.leadIcon,
                      height: 24,
                      color: ColorUtils.secondary,
                    ),
                    const SizedBox(width: 10),
                    TextWidget(
                      text: superExecutiveListSelectedValue,
                      fontSize: 14,
