...
class EditTourExpenses extends StatefulWidget {
  const EditTourExpenses({super.key});

  @override
  State<EditTourExpenses> createState() => _EditTourExpensesState();
}

class _EditTourExpensesState extends State<EditTourExpenses> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: TextWidget(
          text: "Edit tour expense".toUpperCase(),
          fontSize: 15,
