...
import 'package:flexibiz/screens/dashboard/dashboard/tour_expenses/tour_expenses_modify_remarks/tour_expenses_modify_remarks_screen.dart';
...
class TourExpensesModifyRemarksDialog extends StatefulWidget {

  const TourExpensesModifyRemarksDialog({
    super.key,
  });

  @override
  State<TourExpensesModifyRemarksDialog> createState() => _TourExpensesModifyRemarksDialogState();
}

class _TourExpensesModifyRemarksDialogState extends State<TourExpensesModifyRemarksDialog> {
          ...
          children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        child: ButtonWidget(
                          ...
                          //     context,
                          //     child: const TourExpensesModifyRemarksScreen(),
                          ...
                          navigateTo: () {
                            ...
                            ScreenNavigationUtils.push(
                              context,
                              child: TourExpensesModifyRemarksScreen(
                                fromDate: fromDate!,
                                toDate: toDate!,
                              ),
                              type: PageTransitionType.fade,
            ...
            Align(
              ...
              child: Container(
                ...
                child: TextWidget(
                  text: "Modify Tour Expense Remarks",
                  fontSize: 15.5,
