...
class UploadTourExpenses extends StatefulWidget {
  const UploadTourExpenses({super.key});

  @override
  State<UploadTourExpenses> createState() => _UploadTourExpensesState();
}

class _UploadTourExpensesState extends State<UploadTourExpenses> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            TextWidget(
              text: "DELHI FARIDABAD PALWAL AGRA".toUpperCase(),
              fontSize: 15,
              textColor: ColorUtils.white,
              fontWeight: FontWeight.w700,
            ),
            TextWidget(
              text: "Dt 12-dec-2025 Amount 2000".toUpperCase(),
              fontSize: 14,
          ...
          GestureDetector(
            onTap: () {
              ScreenNavigationUtils.push(
                context,
                child: ActivitiesPhotoViewScreen(
        ...
        children: [
          GestureDetector(
            onTap: () {
              ScreenNavigationUtils.push(
                context,
                child: VideoPlayScreen(videoFile: selectedVideos[index]),
                type: PageTransitionType.fade,
              );
            },
            child: Container(
