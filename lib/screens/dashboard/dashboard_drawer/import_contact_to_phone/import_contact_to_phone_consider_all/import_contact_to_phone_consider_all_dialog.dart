...
class ImportContactToPhoneConsiderAllDialog extends StatefulWidget {
  ...
  const ImportContactToPhoneConsiderAllDialog({
    super.key,
  ...
  @override
  State<ImportContactToPhoneConsiderAllDialog> createState() => _ImportContactToPhoneConsiderAllDialogState();
}

class _ImportContactToPhoneConsiderAllDialogState extends State<ImportContactToPhoneConsiderAllDialog> {
