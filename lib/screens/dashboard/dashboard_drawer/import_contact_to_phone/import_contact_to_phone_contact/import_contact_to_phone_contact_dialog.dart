...
class ImportContactToPhoneContactDialog extends StatefulWidget {
  ...
  const ImportContactToPhoneContactDialog({
    super.key,
  ...
  @override
  State<ImportContactToPhoneContactDialog> createState() => _ImportContactToPhoneContactDialogState();
}

class _ImportContactToPhoneContactDialogState extends State<ImportContactToPhoneContactDialog> {
